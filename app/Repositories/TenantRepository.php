...
class TenantRepository
{
    ...
    function createClient($request)
    {
        ...
        $response = $client->request('POST', 'http://subscriptionmanagementsystem.test/api/clients', [
            'headers' => [
                'api-key' => 'Po77NiLBrg',
            ],
            'json' => [
    ...
    function createOnlinePayment($request,$client_id){
        ...
        $response = $client->request('POST', 'http://subscriptionmanagementsystem.test/api/online-payments', [
            'headers' => [
                'api-key' => 'Po77NiLBrg',
            ],
            'json' => [
    ...
    function createSubscription($clientId, $transactionNumber, $packageId){
        ...
        $response = $client->request('POST', 'http://subscriptionmanagementsystem.test/api/clients/subscriptions', [
            'headers' => [
                'api-key' => 'Po77NiLBrg',
            ],
            'json' => [
